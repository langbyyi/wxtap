// Code generated credential-key name list for the sensitive-info scanner. DO NOT EDIT.

package extract

// nucleiKeyNames are key-name patterns aligned with common Nuclei-style credential templates (ProjectDiscovery Nuclei).
var nucleiKeyNames = []string{
	...
	"[\\w_-]*?bucket[\\w_-]*?",
	"[\\w_-]*?token[\\w_-]*?",
	"huawei\\.oss\\.(ak|sk|bucket\\.name|endpoint|local\\.path)",
}
