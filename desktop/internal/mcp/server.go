...
var readOnlyTools = map[string]bool{
	"traffic_list": true, "traffic_get_body": true, "traffic_stats": true,
...
func (s *Server) tools() []toolDef {
	...
	defs := []toolDef{
		...
		// 代码 / 凭据闭环。
		{Name: "code_projects", Description: "List the decompiled mini program projects on disk, each with the absolute path it lives at — the root to pass to miniapp_search_code, code_list_dir and miniapp_read_file",
			InputSchema: schema(map[string]any{})},
